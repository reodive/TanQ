  ...
  return (
    <main className="mx-auto max-w-4xl space-y-6 px-6 py-12" data-testid="forum-thread-page">
      ...
      {thread.posts.map((post) => (
        <Card key={post.id} title={`???: ${post.createdBy.name}`} data-testid="forum-post">
          ...
          <details className="mt-4" data-testid="forum-reply-toggle">
            <summary className="cursor-pointer text-sm text-brand-600">????</summary>
            <div className="mt-3">
      ...
      <Card title="?????" data-testid="forum-thread-reply-form">
